#Asher Holtham & Krishna Srikanth Lab 7
import time
...
def main():
    ...
    print("Begining of 4 LED blinks")
    blink_led(4, 0.5)
    print("4 LED blinks done")

    print("Begining of 5 light inputs")
    read_light(mcp, 5)
    print("End of 5 light inputs")

    print("Begining of 10 LED blinks")
    blink_led(10, 0.2)
    print("10 LED blinks done")

    print("Begining of sound intake")
    read_sound(mcp, 10)
    print("sound intake done")
